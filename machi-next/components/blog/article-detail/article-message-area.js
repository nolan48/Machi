            ...
            <div className={styles[`user-message`]}>
              <div className={styles[`user-name`]}>
                <div className={styles[`img-s`]}>
                  ...
                  <img
                    src={`http://localhost:3005/avatar/${comment?.user?.user_id}.jpg`}
                    onError={(e) => {
                    ...
                    alt=""
                  />
                  <span className={styles[`floor-name`]}>
                    {comment.user.user_account}
                  </span>
                </div>
                <div className={styles[`create-time`]}>
                  {comment.article_comment_createtime.split('T')[0]}
                </div>
              </div>
              <div className={styles['message-content']}>
                <p>{comment.article_comment_content}</p>
              </div>
              <div className={styles[`message-btn`]}></div>
            </div>
          </div>
        ))}
        <p>我要留言</p>
