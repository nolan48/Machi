  ...
  return (
    <>
      <div className="row mt-5 mx-2">
        ...
        <div className="col-sm-5">
          ...
          <p className="product-desc">
            ✨海外滿班秒殺課程<br></br>✨大型甜塔實作班<br></br>
            ✨高效率量產sop大解析<br></br>✨新手也能做出美麗的作品
      ...
      <div className="row mt-5 mx-2">
        <nav
          id="navbar-example2"
          class="navbar navbar-light bg-light justify-content-center align-center-sm flex-space-between"
        >
        ...
        >
          ...
          <p>
            授課方式：示範+實作講堂地點：橙品手作烘焙廚藝教室
            <br />
            主辦單位：橙品小舖承辦單位：橙品手作烘焙廚藝(橙學有限公)
          </p>
          <h4 id="scrollspyHeading3">｜講師介紹｜</h4>
          <p>
            呂昇達 老師 呂昇達經典麵包配方X 私房迷人料理 <br />
